...
class App {
    ...
    private routes(): void {
        ...
        this.express.get('/api/products', (req, res) => {
            this.taskController.getProducts().then(data => res.json(data));
        });
        
        this.express.post('/api/product', (req, res) => {
            console.log(req.body);
            this.taskController.createProduct(req.body.product).then(data => res.json(data));
        });
        
        this.express.put('/api/product', (req, res) => {
            this.taskController.updateProduct(req.body.product).then(data => res.json(data));
        });
        
        this.express.delete('/api/product/:id', (req, res) => {
            this.taskController.deleteProduct(req.params.id).then(data => res.json(data));
        });

        this.express.get("/", (req, res, next) => {
            res.send("Product Management App works!!");
        });
